...
from sched_admin_client.configuration import Configuration
from sched_admin_client.api_response import ApiResponse, T as ApiResponseT
import sched_admin_client.models
from sched_admin_client import rest
from sched_admin_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sched_admin_client.models, klass)
